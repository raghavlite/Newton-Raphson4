...
%     p = fb(m); q = tb(m);
%     disp('-------------------------------------------------------------------------------------');
%     fprintf('%4g', p*10); fprintf('%4g', q*10); fprintf('  %8.3f', Pij(p,q)*10); fprintf('   %8.3f', Qij(p,q)*10); 
%     fprintf('   %4g', q*10); fprintf('%4g', p*10); fprintf('   %8.3f', Pij(q,p)*10); fprintf('   %8.3f', Qij(q,p)*10);
%     fprintf('  %8.3f', Lpij(m)*10); fprintf('   %8.3f', Lqij(m)*10);
%     fprintf('\n');
% end
% disp('-------------------------------------------------------------------------------------');
%disp('#####################################################################################');